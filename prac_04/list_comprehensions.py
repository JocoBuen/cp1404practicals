...
numbers_greater_than_nine = [int(number) for number in numbers if number > 9]
...
long_name = [full_names[i].split()[1] for i in range(len(full_names)) if len(full_names[i]) > 11]
print(", ".join(long_name))
